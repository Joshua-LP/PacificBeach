...
class OfferModal {
        ...
        <div class="offer-modal-body">
          ...
          <div class="savings-section">
            <div class="savings-badge">
              <span class="savings-amount">¡AHORRAS $7,500!</span>
              <span class="savings-percent">-30% OFF</span>
            </div>
            
            <div class="price-breakdown">
              <div class="price-item original">
                <span class="price-label">Precio Original:</span>
                <span class="price-value strikethrough">$25,000</span>
              </div>
              <div class="price-item discount pulse">
                <span class="price-label">Tu Descuento:</span>
                <span class="price-value">-$7,500</span>
              </div>
              <div class="price-item final shine">
  ...
  showCountdownBeforeReveal(modal) {
    const modalBody = modal.querySelector('.offer-modal-body');
    
    modalBody.innerHTML = `
      <div class="countdown-reveal">
        <h3 style="color: var(--navy-blue); font-size: 1.8rem; margin-bottom: 20px;">
          ¡Gracias por tu interés!
        </h3>
        <p style="color: #666; margin-bottom: 30px; font-size: 1.1rem;">
          Tu descuento exclusivo estará disponible por tiempo limitado
        </p>
        <div id="countdown-container"></div>
    ...
    // Después de 3 segundos, mostrar el descuento
    setTimeout(() => {
  ...
  handleFormSubmit(e, modal) {
    ...
    // Mostrar contador antes del reveal
    this.showCountdownBeforeReveal(modal);
  }
